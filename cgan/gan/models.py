...
#on a higher level, we have UNetDown and UNetUp which are building blocks for the downsammpling and upsampling of the generator, then below that we have the discrimantor.
